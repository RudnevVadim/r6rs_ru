...
\item[should]\mainindex{should} Это слово, или прилагательное ``recommended'', означает, что
...
%  by the statement.
\item[should not]\mainindex{should not} Эта фраза, или фраза ``not recommended'', означает, что
...
%  is truly optional.
\item[may]\mainindex{may} Это слово, или прилагательное ``optional'' означает, что

...
\hyper{import level} является одним из следующего:\vspace{1mm}
\begin{scheme}
\textbf{run}
\textbf{expand}
...
Где \hyper{level} представляет точный целый объект.\vspace{1mm}
...
sub-version, если последующий \hyper{sub-version reference} не соответствует ему.\vspace{1mm}

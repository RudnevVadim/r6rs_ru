...
\section{Переменные и компоновка}
...
Подмножество объектов Scheme называется \textit{базисными значениями}\index{datum value}.
...
виде как \textit{синтаксический базис}\index{syntactic datum}, который может быть записан и
...
интерпретаторов и программных преобразователей.
